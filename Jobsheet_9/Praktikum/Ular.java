...
public class Ular extends Hewan{
    ...
    public void bergerak() {
        System.out.println("MMengerutkan otot dari segala sisi hingga membentuk lengkungan");
    ...
    public void bernapas() {
        ...
        System.out.println("Trakea mengirikan udara ke paru-paru");
